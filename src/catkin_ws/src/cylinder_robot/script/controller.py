...
class estimation:
    ...
    def track_trajectory(self):
        rate = rospy.Rate(10)
        threshold = 0.001
        x_controller = PID_Controller(1.3, 0, 0.4, -0.6, 0.6)
        y_controller = PID_Controller(1.3, 0, 0.4, -0.6, 0.6)
        vx_controller = PID_Controller(30, 0, 0.01, -18, 18)
        vy_controller = PID_Controller(30, 0, 0.01, -18, 18)
        target_index = 0
        while target_index * 0 < self.count:
            twist = Twist()
...
if __name__ == '__main__':
    try:
        ...
        trajectory_name = '/home/headless/catkin_ws/src/cylinder_robot/script/test2.txt'
